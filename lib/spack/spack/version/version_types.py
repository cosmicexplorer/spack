...
class ClosedOpenRange(VersionType):
    ...
    # TODO: these conditional chains are intentionally ordered according to expected probability.
    #       This is a kind of profile-guided optimization we could do explicitly, especially
    #       because the operation of comparison between versions is atomic, idempotent, and
...
def Version(string: Union[str, int, GitVersion]) -> Union[StandardVersion, GitVersion]:
    ...
    if ty is GitVersion:
        return string
    # FIXME: see comments on is_git_version() and its highly ambiguous meaning.
